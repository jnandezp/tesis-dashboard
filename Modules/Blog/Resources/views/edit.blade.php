                        ...
                        <form action="{{route('posts.update', $post)}}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="post-title" name="title" placeholder="Enter a title" value="{{ $post->title }}">
                                </div>
                                <div class="form-group">
                                    <label for="post-content">Contenido</label>
                                    <textarea class="form-control" id="post-content" name="content" placeholder="Enter a lorem">
                                        {{ $post->content }}
                                    </textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="publish" {{ $post->publication }}>¿Deseas publicar?</label>
                                </div>
                            </div>
                            <!-- /.card-body -->
